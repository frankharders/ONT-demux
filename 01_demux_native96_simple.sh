#!/usr/bin/env bash
# =============================================================================
# 01_demux_native96_simple.sh
#
# Dorado basecalling + demultiplexing
# Kit:    Native Barcoding Kit 96 V14 (SQK-NBD114-96)
# Mode:   Simpel — barcode detectie aan één uiteinde voldoende
#         Hogere classificatierate, meer unclassified reads krijgen een barcode.
#         Gebruik dit voor standaard samples zonder risico op barcode-contaminatie.
#
# Input:  ./pod5/   (map met .pod5 bestanden, relatief aan pwd)
...
echo "Kit     : $KIT"
echo "Mode    : simpel (single-end barcode detectie)"
...
# -----------------------------------------------------------------------------
# Geen --barcode-both-ends → één barcode-hit voldoende voor classificatie.
